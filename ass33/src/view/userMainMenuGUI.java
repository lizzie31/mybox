...
public class userMainMenuGUI extends JFrame {
	...
	private void initialize() {
		...
		btnShowgroups.setBackground(new Color(240, 240, 240));
		...
		lblSearch.setFont(new Font("Arial Black", Font.PLAIN, 14));
		lblSearch.setBounds(125, 46, 63, 17);
	...
	private JPanel getMainMenu(){
		...
		list.setBounds(30, 105, 168, 167);
		MainMenu.add(list);
		
		
		
		popupMenu = new JPopupMenu();
		popupMenu.setBackground(new Color(0, 191, 255));
		popupMenu.setPopupSize(new Dimension(100, 200));
		//addPopup(list, popupMenu);
		
		JButton btnRead = new JButton("read");
		btnRead.setFont(new Font("Tahoma", Font.BOLD, 11));
		btnRead.setForeground(SystemColor.desktop);
		btnRead.setBackground(SystemColor.menu);
		popupMenu.add(btnRead);
		
		JButton btnWrite = new JButton("write");
		btnWrite.setFont(new Font("Tahoma", Font.BOLD, 11));
		btnWrite.setBackground(SystemColor.menu);
		popupMenu.add(btnWrite);
		...
		JLabel lblFilesList = new JLabel("your files:");
		lblFilesList.setFont(new Font("Arial Black", Font.PLAIN, 13));
		lblFilesList.setBounds(30, 74, 89, 20);
		MainMenu.add(lblFilesList);
	...
	//	component.addListListener(new ListListener) {
